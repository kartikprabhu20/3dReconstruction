...
In practice, collecting data manually is time-consuming, expensive and needs a lot of effort.
...
Further more, companies have realised that synthetic data are a necessity not just for the task which are inconvenient to annotate, but also for improving the performance of existing models.
...
\todo{add more citations for domain adaptation}.
