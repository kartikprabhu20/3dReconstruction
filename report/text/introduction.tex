...
\begin{figure}
    ...
    \caption{A graph showing how synthetic dataset will evolve overtime. The research graph shows that synthetic dataset will overshadow the existing real dataset\textsuperscript{\ref{gartnerreport}}.
