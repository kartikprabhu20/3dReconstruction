...
\autoref{ch:concept} discussed the benchmark datasets Pix3D~\cite{pix3d} and SceneNet~\cite{McCormac:etal:ICCV2017} and how we use them in our synthetic dataset generation pipeline.
