...
In the \autoref{fig:mixed2}, we represent \gls{iou} per category present in the Pix3D and \gls{free}.
...
\begin{figure}
    \centering
    \resizebox{\textwidth}{!}{\input{/Users/apple/OVGU/Thesis/code/3dReconstruction/report/images/evaluation/performance/mixed_parallel_pix2voxpp.pgf}}
    \caption{Parallel coordinate plot for the \gls{iou} for baseline pix2vox trained on 50\% of mixed dataset(\gls{s2rv1}, \gls{s2rv2}) and with pix3d.
    The categories are listed along with the number of images.
