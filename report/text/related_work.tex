...
This chapter discusses the task we will evaluate and the previous work related to the task.
...
We then discuss Domain space in \autoref{sec:domain-space}, how we visualize it qualitatively and quantitatively.
...
Recent trends in Generative models to transfer the style of the real image onto synthetically generated images are also briefly discussed.

\section{3D Reconstruction}\label{sec:3D_reconstruction}
The main task of this thesis is to reconstruct furniture from RGB images.
...
~\cite{georgakis2017synthesizing} proposed domain randomization-based synthetic image generation to detect kitchen objects.
