...
The field of Deep Learning is growing exponentially and has tremendous applications in many domains.
...
Finally, these experimental results demonstrate that the proposed dataset enhances the performances of Deep Neural Net models for the 3D reconstruction task.
