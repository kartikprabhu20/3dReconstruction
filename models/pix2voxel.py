...
class Encoder(BaseModel):
    def __init__(self,config, in_channel = 3):
        ...
        # Layer Definition
        vgg16_bn = torchvision.models.vgg16_bn(pretrained=config.pix2vox_pretrained_encoder)
...
class pix2vox(BaseModel):
    def __init__(self, config):
        ...
        self.decoder2 = Decoder2(config=config)
        ...
        if config.pix2vox_refiner:
            ...
            self.refiner2 = Refiner2(config=config)
