...
class U_Net(nn.Module):
    ...
    def __init__(self, in_ch=1,  out_ch=1,kernel_size =2, stride=2):
        super(U_Net, self).__init__()

        n1 = 64 #TODO: original paper starts with 64
        filters = [n1, n1 * 2, n1 * 4, n1 * 8, n1 * 16]  # 64,128,256,512,1024

        self.Maxpool1 = nn.MaxPool3d(kernel_size=kernel_size, stride=stride)
        self.Maxpool2 = nn.MaxPool3d(kernel_size=kernel_size, stride=stride)
        self.Maxpool3 = nn.MaxPool3d(kernel_size=kernel_size, stride=stride)
        self.Maxpool4 = nn.MaxPool3d(kernel_size=kernel_size, stride=stride)
