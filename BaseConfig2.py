...
cfg.pipeline_type = PipelineType.CYCLEGAN
cfg.dataset_type = DatasetType.SYNTH2REAL
...
cfg.TEST.VOXEL_THRESH                       = [0.025, 0.05, 0.075, .1, .2, .3, .4, .5, .6, .7]
...
cfg.SYNTH2REAL                                    = edict()
cfg.SYNTH2REAL.syntheticsplit                       = cfg.s2r3dfree.train_test_split
cfg.SYNTH2REAL.real_train_indices                   = cfg.pix3d.train_indices
cfg.SYNTH2REAL.real_test_indices                   = cfg.pix3d.test_indices
